public class ControladorDeLetrasJaDigitadas implements Cloneable
{
    ...
    public boolean isJaDigitada (char letra)   //revisar
    {
    ...
    public int hashCode ()
    {
        ...
        ret = ret + 13 * Integer.valueOf(this.letrasJaDigitadas).hashCode();  //ret = 7*ret + new String(this.letrasJaDigitadas).hashCode();
